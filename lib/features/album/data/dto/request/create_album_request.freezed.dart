...
@JsonKey(name: 'userId') String get userId; String get ratio;/// 목표 페이지 수 (완성 기준)
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,userId,ratio,targetPages,coverLayersJson,coverImageUrl,coverThumbnailUrl,coverOriginalUrl,coverPreviewUrl,coverTheme);

@override
String toString() {
  return 'CreateAlbumRequest(userId: $userId, ratio: $ratio, targetPages: $targetPages, coverLayersJson: $coverLayersJson, coverImageUrl: $coverImageUrl, coverThumbnailUrl: $coverThumbnailUrl, coverOriginalUrl: $coverOriginalUrl, coverPreviewUrl: $coverPreviewUrl, coverTheme: $coverTheme)';
}
...
@useResult
$Res call({
@JsonKey(name: 'userId') String userId, String ratio, int targetPages, String coverLayersJson, String coverImageUrl, String coverThumbnailUrl, String? coverOriginalUrl, String? coverPreviewUrl, String coverTheme
});
...
/// Create a copy of CreateAlbumRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? userId = null,Object? ratio = null,Object? targetPages = null,Object? coverLayersJson = null,Object? coverImageUrl = null,Object? coverThumbnailUrl = null,Object? coverOriginalUrl = freezed,Object? coverPreviewUrl = freezed,Object? coverTheme = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'userId')  String userId,  String ratio,  int targetPages,  String coverLayersJson,  String coverImageUrl,  String coverThumbnailUrl,  String? coverOriginalUrl,  String? coverPreviewUrl,  String coverTheme)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CreateAlbumRequest() when $default != null:
return $default(_that.userId,_that.ratio,_that.targetPages,_that.coverLayersJson,_that.coverImageUrl,_that.coverThumbnailUrl,_that.coverOriginalUrl,_that.coverPreviewUrl,_that.coverTheme);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'userId')  String userId,  String ratio,  int targetPages,  String coverLayersJson,  String coverImageUrl,  String coverThumbnailUrl,  String? coverOriginalUrl,  String? coverPreviewUrl,  String coverTheme)  $default,) {final _that = this;
switch (_that) {
case _CreateAlbumRequest():
return $default(_that.userId,_that.ratio,_that.targetPages,_that.coverLayersJson,_that.coverImageUrl,_that.coverThumbnailUrl,_that.coverOriginalUrl,_that.coverPreviewUrl,_that.coverTheme);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'userId')  String userId,  String ratio,  int targetPages,  String coverLayersJson,  String coverImageUrl,  String coverThumbnailUrl,  String? coverOriginalUrl,  String? coverPreviewUrl,  String coverTheme)?  $default,) {final _that = this;
switch (_that) {
case _CreateAlbumRequest() when $default != null:
return $default(_that.userId,_that.ratio,_that.targetPages,_that.coverLayersJson,_that.coverImageUrl,_that.coverThumbnailUrl,_that.coverOriginalUrl,_that.coverPreviewUrl,_that.coverTheme);case _:
  return null;
...
class _CreateAlbumRequest implements CreateAlbumRequest {
  const _CreateAlbumRequest({@JsonKey(name: 'userId') this.userId = '', required this.ratio, this.targetPages = 0, required this.coverLayersJson, required this.coverImageUrl, required this.coverThumbnailUrl, this.coverOriginalUrl, this.coverPreviewUrl, this.coverTheme = ''});
...
/// Create a copy of CreateAlbumRequest
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? userId = null,Object? ratio = null,Object? targetPages = null,Object? coverLayersJson = null,Object? coverImageUrl = null,Object? coverThumbnailUrl = null,Object? coverOriginalUrl = freezed,Object? coverPreviewUrl = freezed,Object? coverTheme = null,}) {
