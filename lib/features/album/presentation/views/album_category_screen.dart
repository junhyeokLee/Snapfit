    ...
    try {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(const SnackBar(content: Text('순서가 저장되었습니다.')));
      }
    } catch (e) {
      if (mounted) {
        ScaffoldMessenger.of(
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            icon: Icon(
              _isEditMode ? Icons.check : Icons.edit_note_rounded,
              color: _isEditMode
      ...
      body: _albums.isEmpty
          ...
          : (() {
              final filteredAlbums = _albums.where((album) {
                ...
                return theme.contains(q) ||
                    title.contains(q) ||
                    album.id.toString().contains(q);
              }).toList();
