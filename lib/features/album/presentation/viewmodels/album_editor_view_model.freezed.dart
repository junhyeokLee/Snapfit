...
/// 현재 페이지의 레이어들(UI가 바로 그릴 데이터)
 ...
 bool get isCreatingInBackground;/// 백그라운드 이미지 업로드 진행률 (0.0 ~ 1.0)
 double get backgroundUploadProgress;/// 되돌리기/다시하기 가능 여부 (현재 페이지 기준)
...
@useResult
$Res call({
 List<LayerModel> layers, CoverSize selectedCover, CoverTheme selectedTheme, Size? coverCanvasSize, Size? innerCanvasSize, bool isCreatingInBackground, double backgroundUploadProgress, bool canUndo, bool canRedo
});
...
/// Create a copy of AlbumEditorState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? layers = null,Object? selectedCover = null,Object? selectedTheme = null,Object? coverCanvasSize = freezed,Object? innerCanvasSize = freezed,Object? isCreatingInBackground = null,Object? backgroundUploadProgress = null,Object? canUndo = null,Object? canRedo = null,}) {
...
as bool,backgroundUploadProgress: null == backgroundUploadProgress ? _self.backgroundUploadProgress : backgroundUploadProgress // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<LayerModel> layers,  CoverSize selectedCover,  CoverTheme selectedTheme,  Size? coverCanvasSize,  Size? innerCanvasSize,  bool isCreatingInBackground,  double backgroundUploadProgress,  bool canUndo,  bool canRedo)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AlbumEditorState() when $default != null:
return $default(_that.layers,_that.selectedCover,_that.selectedTheme,_that.coverCanvasSize,_that.innerCanvasSize,_that.isCreatingInBackground,_that.backgroundUploadProgress,_that.canUndo,_that.canRedo);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<LayerModel> layers,  CoverSize selectedCover,  CoverTheme selectedTheme,  Size? coverCanvasSize,  Size? innerCanvasSize,  bool isCreatingInBackground,  double backgroundUploadProgress,  bool canUndo,  bool canRedo)  $default,) {final _that = this;
switch (_that) {
case _AlbumEditorState():
return $default(_that.layers,_that.selectedCover,_that.selectedTheme,_that.coverCanvasSize,_that.innerCanvasSize,_that.isCreatingInBackground,_that.backgroundUploadProgress,_that.canUndo,_that.canRedo);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<LayerModel> layers,  CoverSize selectedCover,  CoverTheme selectedTheme,  Size? coverCanvasSize,  Size? innerCanvasSize,  bool isCreatingInBackground,  double backgroundUploadProgress,  bool canUndo,  bool canRedo)?  $default,) {final _that = this;
switch (_that) {
case _AlbumEditorState() when $default != null:
return $default(_that.layers,_that.selectedCover,_that.selectedTheme,_that.coverCanvasSize,_that.innerCanvasSize,_that.isCreatingInBackground,_that.backgroundUploadProgress,_that.canUndo,_that.canRedo);case _:
  return null;
...
@override@JsonKey() final  double backgroundUploadProgress;
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_layers),selectedCover,selectedTheme,coverCanvasSize,innerCanvasSize,isCreatingInBackground,backgroundUploadProgress,canUndo,canRedo);
...
/// Create a copy of AlbumEditorState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? layers = null,Object? selectedCover = null,Object? selectedTheme = null,Object? coverCanvasSize = freezed,Object? innerCanvasSize = freezed,Object? isCreatingInBackground = null,Object? backgroundUploadProgress = null,Object? canUndo = null,Object? canRedo = null,}) {
