...
2026-09-09 이후 템플릿 작업은 컨셉에 맞는 재료가 부족하면 신규 프레임·문구·장식을
함께 제작하고 편집기에 연결한다. 색만 바꾼 복제품을 유료 재료로 늘리지 않는다.
기본 재료는 무료로 유지하고, 신규 상품은 [출시 가격 기준](point_shop_launch_pricing.md)에
따라 상품별 가격과 이유를 기록한다. 책정과 실제 판매 개시를 분리하며 기존 무료
앨범·운영 가격을 일괄 변경하지 않는다. 상세한 최근 재료 기준은
[프레임·문구 확장](atelier_material_expansion.md)을 따른다.
