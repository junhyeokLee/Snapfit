# Scrapbook Image Sources

Production status: `needs-replacement`

This file tracks image provenance for `scrapbook`. Existing bundled/remote preview images are treated as legacy or temporary until each row is replaced with verified commercial-use source metadata.
