# Wedding Editorial Image Sources

Production status: `needs-replacement`

This file tracks image provenance for `wedding_editorial`. Existing bundled/remote preview images are treated as legacy or temporary until each row is replaced with verified commercial-use source metadata.
...
Pinterest, MiriCanvas, Canva, Instagram, portfolio, and blog images may be pasted here only as mood references. They must never become bundled app assets.
