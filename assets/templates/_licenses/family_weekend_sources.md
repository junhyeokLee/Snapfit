# 가족의 주말 Image Sources

Production status: `needs-replacement`

This file tracks image provenance for `family_weekend`. Existing bundled/remote preview images are treated as legacy or temporary until each row is replaced with verified commercial-use source metadata.
