# SAVE THE DATE Image Sources

Production status: `needs-replacement`

This file tracks image provenance for `save_the_date`. Existing bundled/remote preview images are treated as legacy or temporary until each row is replaced with verified commercial-use source metadata.
