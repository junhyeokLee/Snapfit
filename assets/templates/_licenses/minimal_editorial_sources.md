# 화이트 에디토리얼 Image Sources

Production status: `needs-replacement`

This file tracks image provenance for `minimal_editorial`. Existing bundled/remote preview images are treated as legacy or temporary until each row is replaced with verified commercial-use source metadata.
